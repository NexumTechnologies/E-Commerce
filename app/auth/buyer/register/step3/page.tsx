...
import SellerRegisterStep3 from "@/components/auth/SellerRegisterStep3";
import SignInPromo from "@/components/auth/SignInPromo";

export default function BuyerRegisterStep3Page() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="md:hidden">
        <div className="bg-gradient-to-br from-[#6b21a8] to-[#8b5cf6] px-4 py-4 flex items-center gap-3">
          ...
          <h1 className="text-white text-[18px] font-bold">Verify Your Business</h1>
        </div>
