      ...
      <header className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="hidden sm:block">
            <Link href="/admin/approvals/buyers" className="text-sm text-[#7c3aed]">
              View Approvals
            </Link>
          </div>
          <div>
                ...
                {users.map((b: any) => (
                  <li key={b.id} className="flex items-center justify-between py-3">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <Link href={`/admin/users/buyers/${b.id}`} className="inline-flex items-center gap-2 text-sm bg-indigo-600 text-white px-3 py-1 rounded-lg hover:bg-indigo-700">View</Link>
                    </div>
                  </li>
                ))}
              </ul>
